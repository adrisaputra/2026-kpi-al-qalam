            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    <div id="tableHover" class="col-lg-12 col-12 layout-spacing">
						...
						@include('admin.kpi_bonus.create')
                        ...
                        <div class="alert alert-danger mb-4" role="alert"> 
                            ...
                            </button> <h4 style="color: #ffffff;"><i class="icon fa fa-check"></i> Gagal !</h4>
                            {{ $message }}
                        </div>     
						@endif  
                    	
                        <div class="table-responsive">
								<table class="table table-bordered table-hover mb-12" id="kpi_bonus-category-table">
									<thead>
										<tr>
...
<script>
    ...
    $(document).ready(function () {
        table = $('#kpi_bonus-category-table').DataTable({
            processing: true,
            serverSide: true,
			ajax: {
				url: "{{ route('kpi_bonus.list', ['kpi' => Crypt::encrypt($kpi->id)]) }}",
				type: 'GET',
				dataType: 'json',
			},
            columns: [
        ...
        $('#myForm').submit(function (e) {
            ...
            var id_kpi_bonus = $('#id_kpi_bonus').val();
            ...
            formData.append('id', id_kpi_bonus);
            ...
            var url = "{{ url('/kpi_bonus/validate') }}";
            $.ajax({
                url: url + "/" + action,
                type: "POST",
                data: formData,

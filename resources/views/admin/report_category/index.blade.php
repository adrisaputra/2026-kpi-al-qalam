            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    <div id="tableHover" class="col-lg-12 col-12 layout-spacing">
						...
						@include('admin.report_category.create')
							...
							<div class="table-responsive">
								<table class="table table-bordered table-hover mb-12" id="report-category-table">
									<thead>
										<tr>
											<th style="width: 2%">Number</th>
											<th style="width: 2%">No</th>
											<th>Nama Kategori Rapor</th>
											<th>Aksi</th>
...
<script>
    ...
    $(document).ready(function () {
        table = $('#report-category-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('report_category/list') }}",
            columns: [
        ...
        $('#myForm').submit(function (e) {
            ...
            var url = "{{ url('/report_category/validate') }}";
            $.ajax({
                url: url + "/" + action,
                type: "POST",
                data: formData,
    ...
    function getData(id){
        ...
        var url = "{{ url('/report_category/edit') }}";
        $.ajax({
            url: url + "/" + id,
            type: "GET",
            success: function (response) {
        ...
        swal({
			...
			if (result.value) {
				swal(
					...
					var url = "{{ url('/report_category/delete') }}";
                    $.ajax({
                        url: url + "/" + id,
                        success: function (response) {

            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    <div id="tableHover" class="col-lg-12 col-12 layout-spacing">
						...
						@include('admin.kpi_category.create')
							...
							<div class="table-responsive">
								<table class="table table-bordered table-hover mb-12" id="kpi-category-table">
									<thead>
										<tr>
											<th style="width: 2%">Number</th>
											<th style="width: 2%">No</th>
											<th>Nama Kategori KPI</th>
											<th>Aksi</th>
...
<script>
    ...
    $(document).ready(function () {
        table = $('#kpi-category-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('kpi_category/list') }}",
            columns: [
    ...
    function getData(id){
        ...
        var url = "{{ url('/kpi_category/edit') }}";
        $.ajax({
            url: url + "/" + id,
            type: "GET",
            success: function (response) {
                document.getElementById("id_kpi_category").value = response.data.id;
        ...
        swal({
			...
			if (result.value) {
				swal(
					...
					var url = "{{ url('/kpi_category/delete') }}";
                    $.ajax({
                        url: url + "/" + id,
                        success: function (response) {

...
<script>
    ...
    $(document).ready(function () {
        table = $('#report-category-table').DataTable({
            ...
            serverSide: true,
			ajax: {
				url: "{{ route('report.list', ['report_category' => Crypt::encrypt($report_category->id)]) }}",
				type: 'GET',
				dataType: 'json',
			},
            columns: [

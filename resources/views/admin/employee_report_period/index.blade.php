            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    <div id="tableHover" class="col-lg-12 col-12 layout-spacing">
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-12 col-sm-12 col-12">
                                    <a href="#" class="btn mb-2 mr-1 btn-success" id="create_period" onClick="generateReport({{ $employee_report_category->id }});"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg></a>
						...
						<p style="font-size:20px;font-weight:bold;text-align:center">Bulan {{ \App\Helpers\Helpers::month_name($employee_report_category->month) }} Tahun {{ $employee_report_category->year }}</p>
